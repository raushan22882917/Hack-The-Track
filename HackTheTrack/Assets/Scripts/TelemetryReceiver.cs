...
public class TelemetryReceiver : MonoBehaviour {
    ...
    private Dictionary<string, TelemetryVehicleController> vehicles = new Dictionary<string, TelemetryVehicleController>();
            ...
            try {
                ...
                if (frame.type == "telemetry_frame") {
                    foreach (var kv in frame.vehicles) {
                        ...
                        vehicles[vehicleId].ApplyTelemetry(samples);
                    }
